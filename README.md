...
<p align="center">
  <img src="images/preview.jpg" alt="Addax-AI Lightroom Plugin Banner" style="width: 90%; max-width: 100%;">
</p>
...
### Managing Models
To add or update models, use the **Addax-AI standalone application**. Once a model is downloaded and configured there, it will automatically appear in the Lightroom plugin's model selection list.
